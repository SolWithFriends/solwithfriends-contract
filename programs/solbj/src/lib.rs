...
declare_id!("Eo2L4feDSHRMZUaz2MDPjh856Ey8UiNKrDw6zTbzScKg");
...
pub mod solbj {
    ...
    // Blackjack
    // Blackjack Dealer
    pub fn create_table(ctx: Context<CreateTableCtx>, title: String, max_bet: u64, min_bet: u64, split_allowed: bool, double_allowed: bool, dealer_liquidity: u64, max_players: u8, time_between_hands: i64, time_between_actions: i64, inactivity_timeout: i64, table_fee: u8, huddle_room_id: String) -> Result<()> {
        instructions::create_table(ctx, title, max_bet, min_bet, split_allowed, double_allowed, dealer_liquidity, max_players, time_between_hands, time_between_actions, inactivity_timeout, table_fee, huddle_room_id)
    }
